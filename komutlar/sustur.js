...
exports.run = (client, message, args) => {
  ...
  if (!muteRole) return message.reply('`Susturulmuş` adlı bir rol bulamıyorum. Lütfen Susturulmuş adlı bir rol oluşturun ve bu komutu tekrar deneyin.').catch(console.error);
